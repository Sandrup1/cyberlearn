...
function createDraft(content: CourseContent): DraftContent {
  return {
    title: content.title,
...
const initialDrafts = moduleIds.reduce((drafts, moduleId) => {
  ...
  return drafts;
}, {} as Record<CourseModuleId, DraftContent>);

export default function AdminLabsPage() {
  const [selectedModuleId, setSelectedModuleId] =
    useState<CourseModuleId>("sqli");
  const [drafts, setDrafts] =
    useState<Record<CourseModuleId, DraftContent>>(initialDrafts);
  ...
  function updateDraft(field: keyof DraftContent, value: string | boolean) {
    setDrafts((current) => ({
      ...current,
      [selectedModuleId]: {
