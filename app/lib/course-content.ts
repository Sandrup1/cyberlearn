...
export const moduleIds: string[] = ["sqli", "xss", "csrf", "xxe"];

export const defaultCourseContents: Record<string, CourseContent> = {
  sqli: {
    moduleId: "sqli",
    title: "SQL Injection",
    shortTitle: "SQLi",
...
export function getDefaultCourseContent(moduleId: string) {
